...
# Neural Network - Breadth Focused
# Model focus - 4 Linear Layers with 1 dropout and Relu
# 1st linear (data input) -> 2nd layer Dense -> 2nd layer Dense to output layer
# Dropout and Relu occurs on the dense layers
# The Breadth Neural Network focuses on Using more neurons per hidden layer and less
# hidden layers in the entire model. This approach aims at reducing the model complexity
# and despite having to calculate for each neuron, this can reduce computation as there is
# less backpropogation through layers. 
class Net(nn.Module):

    def __init__(self, num_input_features):
        super(Net, self).__init__()

        self.fc1 = nn.Linear(num_input_features, 2048) 
